// Deepseek API integration for generating coaching responses
const API_KEY = 'YOUR_DEEPSEEK_API_KEY'; // Replace with your own API key
const API_URL = 'https://api.deepseek.com/v1/chat/completions';
const MODEL = 'deepseek-chat';

// Generate coaching response using Deepseek
export const generateResponse = async (userInput, persona, coachingType, discType, duration) => {
  try {
    ...
    const formattedInput = `[${duration} minutes ${coachingType.label} session | DISC: ${discType.label}] ${userInput}`;
